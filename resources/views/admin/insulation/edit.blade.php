        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Insulation</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                                              ...
                                              @foreach($langs as $key=>$value)
                                                  <div class="tab-pane @if($key == 'de') active @endif" id="{{$key}}">
                                                      <div class="form-group">
                                                          ...
                                                          <input type="text" name="ins_name[{{$key}}]" value="@if (array_key_exists($key,$insulation->getTranslations('name'))) {{$insulation->getTranslations('name')[$key]}} @endif"  class="form-control" id="mod_name" placeholder="Enter Category Name">
                                                      </div>
