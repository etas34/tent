    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('admin.category.update',[app()->getLocale(),$category])}}" method="post"
                        ...
                        <div class="form-group">
                            @if($category->image)
                                <div class="form-group">
                                    ...
                                    <div id="file"><img src="{{asset("storage/images/cat_images/$category->image")}}"
                                                        width="300" alt="..."></div>
                                </div>
                            @endif
                            ...
                            @if($category->banner)
                                <div class="form-group">
                                    <label for="file">Selected Image:</label>
                                    <div id="file"><img
                                            src="{{asset("storage/images/banner_images/$category->banner")}}"
                                            width="300" alt="..."></div>
                                </div>
                            @endif
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="banner" accept="image/*" class="custom-file-input"
                                               id="exampleInputFile">
                                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                    </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="sira">
                                        ...
                                        @for($i = 1 ; $i <= \App\Models\Category::count() ; $i++ )
                                            <option @if($category->sira == $i) selected
                                        ...
                                        <div class="card-header d-flex p-0">
                                            ...
                                            <ul class="nav nav-pills ml-auto p-2">
                                                @foreach($langs as $key=>$value)
                                                    <li class="nav-item"><a
                                                            class="nav-link @if($key == 'de') active @endif"
                                                            href="#{{$key}}" data-toggle="tab">{{$value}}</a></li>
                                                    ...
                                                    <div class="tab-pane @if($key == 'de') active @endif" id="{{$key}}">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="cat_name[{{$key}}]"
                                                                   value="@if (array_key_exists($key,$category->getTranslations('name'))) {{$category->getTranslations('name')[$key]}} @endif"
                                                                   class="form-control" id="cat_name"
                                                                   placeholder="Enter Category Name">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Category Description ({{$value}})</label>
                                                            <textarea class="summernote" id="summernote_{{$key}}"
                                                                      name="description[{{$key}}]">
                                    {{$category->getTranslations('description')[$key] ?? ''}}
                                                        </textarea>
