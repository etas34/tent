    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('admin.model.store')}}" method="post" autocomplete="off"  enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mod_name"  class="form-control" id="mod_name" placeholder="Enter Category Name">
                        </div>
