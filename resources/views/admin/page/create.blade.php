<x-admin-app>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('admin.page.store', app()->getLocale())}}" method="post" autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-body">
                                        <input type="checkbox"  name="visibility" data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
